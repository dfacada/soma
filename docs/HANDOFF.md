...
- **A day cannot close until Journal ships**: closing needs a journal entry, and recording is not built yet. Today's Journal card says so instead of pretending.
